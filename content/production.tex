...
This is accomplished by using the surface implantation. The process iterates until all the deep implants layers and the read-out implants are created. %FIXME bad english, rephrase
...
Therefore, it is necessary to consider this increase in the size in the sensor design.%FIXME finish sentence

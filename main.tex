...
In order to find optimal parameters of the design of the sensors,  two types of simulations have been carried out: %FIXME You repeat the first half sentence twice: In order to find an optimal sensor design, ...  In order to find optimal parameters of the design of the sensors, ...  Please right it more compact. 
